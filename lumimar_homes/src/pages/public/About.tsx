        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 ">
            ...
            <a
              ...
              className="inline-flex min-h-14 items-center justify-center gap-2 bg-[#25D366] text-white px-5 py-3 rounded-lg text-sm font-bold hover:bg-[#1ebc5a] transition-colors text-center"
            >
              ...
              <span className="whitespace-nowrap">+254 705 551 021</span>
            </a>
            <a
              href="mailto:hello@home.lumimarbrand.com"
              className="inline-flex min-h-14 items-center justify-center gap-2 border border-outline-variant/30 text-primary px-5 py-3 rounded-lg text-sm font-bold hover:bg-surface-container transition-colors text-center"
            >
              <span className="material-symbols-outlined">mail</span>
              <span className="break-all">hello@home.lumimarbrand.com</span>
            </a>
          </div>
        </div>
      </section>
